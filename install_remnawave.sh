#!/bin/bash
# Reactus — Remnawave Reverse Proxy Setup Script
# Author: Reactus
# Repository: https://github.com/dlcloudpro/remnawave-reverse-proxy
#
# Based on the original work by eGamesAPI:
...
SCRIPT_URL="https://raw.githubusercontent.com/dlcloudpro/remnawave-reverse-proxy/refs/heads/main/install_remnawave.sh"
...
show_menu() {
    ...
    echo -e "${COLOR_GRAY}Автор: Reactus${COLOR_RESET}"
    echo -e ""
